...
?>
	...
	<head>
	 ...
	 <title>LISTADO CURSOS NO ACTIVOS</title>
...
<?php
   ...
   if (!isset($_GET['catID']))
	...
	{	
		...
		$sql1 = "SELECT * FROM cursos WHERE (curso_activo=0 OR fin_curso < CURDATE()) AND nombre_curso LIKE '%Experto%'";
		...
		$sql11="SELECT * FROM cursos WHERE (curso_activo = 0 OR fin_curso < CURDATE()) AND nombre_curso NOT LIKE '%Experto%'";
...
?>
        ...
        <input type="text" name="totalActivos" value="<?php echo " Num.cursos no activos = $count0"?>" 
 		id="totalActivos" style="width: 210px; background: coral; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:10pt; font-weight:bold; border: 1px solid #ccc; align:center;" readonly>	  
		...
		{		
			if ($count1 > 0)
			{
				...
				{	
					...
					///distinguimos entre cursos ya finalizados o cursos suspendidos
					$sql4 = "SELECT * FROM cursos WHERE curso_id=$curso_id AND fin_curso < '$hoy'";
					...
					if ($count4 >0)
						echo "<U><font style=\"width:420; background: #ccffcc ; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:10pt; font-weight:bold;  border: 1px solid #ccc;\" readonly> curso ya finalizado </font></U>";
					else
						echo "<U><font style=\"width:420; background: #ccffcc ; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:10pt; font-weight:bold;  border: 1px solid #ccc;\" readonly> temporalmente suspendido </font></U>";
...
<?php
			...
			//echo "<br>No hay cursos pasados en este momento<br>";
?>
                <p> 
				<center> <input type="text" name="totalCurso" value="<?php echo " No hay cursos inactivos en este momento"?>" 
				id="totalCurso" style="width: 390px; background: lightblue; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:10pt; font-weight:bold; border: 1px solid #ccc; align:center;" readonly> </center>	  
				<br><br>
...
<?php
			...
			//echo "<br>No hay cursos pasados en este momento<br><br>";
?>
                <p> 
				<center> <input type="text" name="totalCurso" value="<?php echo " No hay cursos inactivos en este momento"?>" 
